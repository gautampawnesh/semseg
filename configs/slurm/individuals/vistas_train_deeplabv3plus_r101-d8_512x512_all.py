experiment = dict(
    name="Vistas Individuals ",
    description=" Deeplabv3+  with 1L samples "
)
# directory to save logs and models
work_dir = "/netscratch/gautam/semseg/final_weights/vistas"
# random seed das
seed = 1
...
_base_ = [
    ...
    '../../_base_/datasets/individuals/vistas.py',
]
ignore_index = 0
...
model = dict(
    decode_head=dict(ignore_index=ignore_index, num_classes=65)
)
