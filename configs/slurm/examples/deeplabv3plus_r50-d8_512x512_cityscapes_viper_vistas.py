...
work_dir = "/netscratch/gautam/semseg/exp_results/all_six_deeplabv3plus_67c/"
# random seed
seed = 1
# checkpoint file to load weights from
load_from = "/netscratch/gautam/semseg/exp_results/all_six_deeplabv3plus_67c/training/20220531_235016/epoch_30.pth"
...
evaluation = dict(_delete_=True, interval=1, metric="mIoU", gpu_collect=True, pre_eval=True, save_best="0_mIoU")
