...
city_data = dict(
    train=dict(
        ...
        extra_img_dir="leftImg8bit/val",
        extra_ann_dir="gtFine/val",
...
viper_data = dict(
    train=dict(
        ...
        extra_img_dir='val/img',
        extra_ann_dir='val/cls',
        img_dir='train/img',
        ann_dir='train/cls',
        seg_map_suffix='.png',
        img_suffix=".jpg",
...
vistas_data = dict(
    train=dict(
        ...
        extra_img_dir='validation/images',
        extra_ann_dir='validation/v1.2/labels',
...
ade_data = dict(
    train=dict(
        ...
        extra_img_dir='images/validation',
        extra_ann_dir='annotations/validation',
...
scannet_data = dict(
    train=dict(
        ...
        split=["/netscratch/gautam/scannet/scannet_train.json", "/netscratch/gautam/scannet/scannet_val.json"],
        universal_class_colors_path="/netscratch/gautam/semseg/configs/_base_/class_mapping/universal_classes.csv",
