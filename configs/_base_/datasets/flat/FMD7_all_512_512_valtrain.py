...
city_data = dict(
    train=dict(
        ...
        num_samples=20000,
        data_seed=data_seed,
        img_meta_data="/netscratch/gautam/semseg/FMD7_data_metadata/cityscapes_raw_train_dataset.csv",
    ...
    val=dict(
        ...
        dataset_class_mapping="/netscratch/gautam/semseg/configs/_base_/class_mapping/cityscapes_class_mapping.csv",
        seg_map_suffix='_gtFine_labelIds.png',
        img_meta_data="/netscratch/gautam/semseg/FMD7_data_metadata/cityscapes_raw_val_dataset.csv",
        ignore_index=0,  # gt has Labelids
        dataset_name="cityscapes",
        test_mode=True,
        num_samples=200,
...
viper_data = dict(
    train=dict(
        ...
        seg_map_suffix='.png',
        img_suffix=".jpg",
        img_meta_data="/netscratch/gautam/semseg/FMD7_data_metadata/viper_raw_train_dataset.csv",
        universal_class_colors_path="/netscratch/gautam/semseg/configs/_base_/class_mapping/universal_classes.csv",
    ...
    val=dict(
        ...
        seg_map_suffix='.png',
        img_suffix=".jpg",
        img_meta_data="/netscratch/gautam/semseg/FMD7_data_metadata/viper_raw_val_dataset.csv",
        universal_class_colors_path="/netscratch/gautam/semseg/configs/_base_/class_mapping/universal_classes.csv",
        dataset_class_mapping="/netscratch/gautam/semseg/configs/_base_/class_mapping/viper_class_mapping.csv",
        dataset_name="viper",
        ignore_index=0,  # gt are Label ids
...
vistas_data = dict(
    train=dict(
        ...
        seg_map_suffix='.png',
        img_meta_data="/netscratch/gautam/semseg/FMD7_data_metadata/vistas_raw_train_dataset.csv",
        universal_class_colors_path="/netscratch/gautam/semseg/configs/_base_/class_mapping/universal_classes.csv",
...
ade_data = dict(
    train=dict(
        ...
        seg_map_suffix='.png',
        img_meta_data="/netscratch/gautam/semseg/FMD7_data_metadata/ade_raw_train_dataset.csv",
        universal_class_colors_path="/netscratch/gautam/semseg/configs/_base_/class_mapping/universal_classes.csv",
    ...
    val=dict(
        ...
        img_meta_data="/netscratch/gautam/semseg/FMD7_data_metadata/ade_raw_val_dataset.csv",
        universal_class_colors_path="/netscratch/gautam/semseg/configs/_base_/class_mapping/universal_classes.csv",
        dataset_class_mapping="/netscratch/gautam/semseg/configs/_base_/class_mapping/ade20k_class_mapping.csv",
        seg_map_suffix='.png',
        is_color_to_uni_class_mapping=False,
...
wild_data = dict(
    train=dict(
        ...
        ann_dir='labels',
        seg_map_suffix='.png',
        img_meta_data="/netscratch/gautam/semseg/FMD7_data_metadata/wilddash_raw_train_dataset.csv",
        universal_class_colors_path="/netscratch/gautam/semseg/configs/_base_/class_mapping/universal_classes.csv",
...
scannet_data = dict(
    train=dict(
        ...
        img_meta_data="/netscratch/gautam/semseg/FMD7_data_metadata/scannet_raw_train_dataset.csv",
        universal_class_colors_path="/netscratch/gautam/semseg/configs/_base_/class_mapping/universal_classes.csv",
    ...
    val=dict(
        ...
        img_meta_data="/netscratch/gautam/semseg/FMD7_data_metadata/scannet_raw_val_dataset.csv",
        universal_class_colors_path="/netscratch/gautam/semseg/configs/_base_/class_mapping/universal_classes.csv",
        dataset_class_mapping="/netscratch/gautam/semseg/configs/_base_/class_mapping/scannet_class_mapping.csv",
        seg_map_suffix='_labelId.png',
        num_samples=200,
...
idd_data = dict(
    train=dict(
        ...
        num_samples=2000,
        data_seed=data_seed,
        img_meta_data="/netscratch/gautam/semseg/raw_data_metadata/idd_raw_train_dataset.csv",
        universal_class_colors_path="/netscratch/gautam/semseg/configs/_base_/class_mapping/universal_classes.csv",
...
gta_data = dict(
    train=dict(
        ...
        img_meta_data="/netscratch/gautam/semseg/raw_data_metadata/playing_for_data_raw_train_dataset.csv",
        universal_class_colors_path="/netscratch/gautam/semseg/configs/_base_/class_mapping/universal_classes.csv",
...
bdd_data = dict(
    train=dict(
        ...
        num_samples=5000,
        data_seed=data_seed,
        img_meta_data="/netscratch/gautam/semseg/raw_data_metadata/bdd_raw_train_dataset.csv",
        universal_class_colors_path="/netscratch/gautam/semseg/configs/_base_/class_mapping/universal_classes.csv",
...
data = dict(
    train=dict(
        ...
        datasets=[idd_data["train"], bdd_data["train"], gta_data["train"], city_data["train"], viper_data["train"], vistas_data["train"], ade_data["train"],
