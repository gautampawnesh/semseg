...
data_root = '/ds-av/public_datasets/scannet/pre'
img_norm_cfg = dict(
...
data = dict(
    train=dict(
        ...
        ann_dir='/scans',
        seg_map_suffix='.png',
        split="/ds-av/public_datasets/scannet/pre/scannet_train.json",
    ...
    val=dict(
        ...
        img_dir='/scans',
        ann_dir='/scans',
        split="/ds-av/public_datasets/scannet/pre/scannet_val.json",
        universal_class_colors_path="/netscratch/gautam/semseg/configs/_base_/class_mapping/universal_classes.csv",
        dataset_class_mapping="/netscratch/gautam/semseg/configs/_base_/class_mapping/scannet_class_mapping.csv",
        seg_map_suffix='.png',
        num_samples=1000,
