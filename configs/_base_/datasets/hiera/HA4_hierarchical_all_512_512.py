...
city_data = dict(
    train=dict(
        ...
        num_samples=100000,
        data_seed=data_seed,
        img_meta_data="/netscratch/gautam/semseg/raw_data_metadata/cityscapes_raw_train_dataset.csv",
...
idd_data = dict(
    ...
    val=dict(
        ...
        ann_dir='gtFine/val',
        dataset_name="idd",
        img_meta_data="/netscratch/gautam/semseg/raw_data_metadata/idd_raw_val_dataset.csv",
        universal_class_colors_path="/netscratch/gautam/semseg/configs/_base_/class_mapping/universal_classes.csv",
        dataset_class_mapping="/netscratch/gautam/semseg/configs/_base_/class_mapping/idd_class_mapping.csv",
        pipeline=test_pipeline),
    test=dict(
...
bdd_data = dict(
    ...
    val=dict(
        ...
        universal_class_colors_path="/netscratch/gautam/semseg/configs/_base_/class_mapping/universal_classes.csv",
        dataset_class_mapping="/netscratch/gautam/semseg/configs/_base_/class_mapping/bdd10k_class_mapping.csv",
        img_meta_data="/netscratch/gautam/semseg/raw_data_metadata/bdd_raw_val_dataset.csv",
        pipeline=test_pipeline),
    test=dict(
        type='UniversalBdd10kDataset',
        data_root='/ds-av/public_datasets/bdd100k/raw',
