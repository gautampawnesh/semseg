...
hierarchical_aux_heads_config = dict(
    ...
    level_3_small_vehicles_head=dict(common_auxiliary_head,
                                     **{"num_classes": len(class_hierarchy_heads["level_3_small_vehicles_head"]) + 1}),
    level_3_large_vehicles_head=dict(common_auxiliary_head,
                                     **{"num_classes": len(class_hierarchy_heads["level_3_large_vehicles_head"]) + 1}),
    level_3_two_wheelers_head=dict(common_auxiliary_head,
                                   **{"num_classes": len(class_hierarchy_heads["level_3_two_wheelers_head"]) + 1}),
    level_3_other_vehicles_head=dict(common_auxiliary_head,
                                     **{"num_classes": len(class_hierarchy_heads["level_3_other_vehicles_head"]) + 1}),
    # Road head
    level_2_flat_head=dict(common_auxiliary_head, **{"num_classes": len(class_hierarchy_heads["level_2_flat_head"]) + 1}),
    level_3_normal_road_head=dict(common_auxiliary_head,
                                  **{"num_classes": len(class_hierarchy_heads["level_3_normal_road_head"]) + 1}),
    level_3_road_marking_head=dict(common_auxiliary_head,
                                   **{"num_classes": len(class_hierarchy_heads["level_3_road_marking_head"]) + 1}),
    # construction
    level_2_construction_head=dict(common_auxiliary_head,
                                   **{"num_classes": len(class_hierarchy_heads["level_2_construction_head"]) + 1}),
    level_3_building_infra_head=dict(common_auxiliary_head,
                                     **{"num_classes": len(class_hierarchy_heads["level_3_building_infra_head"]) + 1}),
    level_3_other_infra_head=dict(common_auxiliary_head,
                                  **{"num_classes": len(class_hierarchy_heads["level_3_other_infra_head"]) + 1}),

    # Road objects
    level_2_traffic_objects_head=dict(common_auxiliary_head, **{
        "num_classes": len(class_hierarchy_heads["level_2_traffic_objects_head"]) + 1}),
    level_3_pole_all_head=dict(common_auxiliary_head,
                               **{"num_classes": len(class_hierarchy_heads["level_3_pole_all_head"]) + 1}),
    level_3_sign_head=dict(common_auxiliary_head, **{"num_classes": len(class_hierarchy_heads["level_3_sign_head"]) + 1}),
    level_3_light_head=dict(common_auxiliary_head,
                            **{"num_classes": len(class_hierarchy_heads["level_3_light_head"]) + 1}),
    level_3_other_road_objects_head=dict(common_auxiliary_head, **{
        "num_classes": len(class_hierarchy_heads["level_3_other_road_objects_head"]) + 1}),
    # Nature objects
    level_2_nature_objects_head=dict(common_auxiliary_head,
                                     **{"num_classes": len(class_hierarchy_heads["level_2_nature_objects_head"]) + 1}),
    level_3_sky_vegetation_head=dict(common_auxiliary_head,
                                     **{"num_classes": len(class_hierarchy_heads["level_3_sky_vegetation_head"]) + 1}),
    level_3_ground_head=dict(common_auxiliary_head,
                             **{"num_classes": len(class_hierarchy_heads["level_3_ground_head"]) + 1}),
    level_3_other_nature_objects_head=dict(common_auxiliary_head, **{
        "num_classes": len(class_hierarchy_heads["level_3_other_nature_objects_head"]) + 1}),
    # VRU
    level_2_vru_head=dict(common_auxiliary_head, **{"num_classes": len(class_hierarchy_heads["level_2_vru_head"]) + 1}),
    level_3_animal_head=dict(common_auxiliary_head,
                             **{"num_classes": len(class_hierarchy_heads["level_3_animal_head"]) + 1}),
    level_3_rider_head=dict(common_auxiliary_head,
                            **{"num_classes": len(class_hierarchy_heads["level_3_rider_head"]) + 1}),
    # Indoor objects
    level_2_indoor_objects_head=dict(common_auxiliary_head,
                                     **{"num_classes": len(class_hierarchy_heads["level_2_indoor_objects_head"]) + 1}),
    level_3_furniture_head=dict(common_auxiliary_head,
                                **{"num_classes": len(class_hierarchy_heads["level_3_furniture_head"]) + 1}),
    level_3_bedroom_objects_head=dict(common_auxiliary_head, **{
        "num_classes": len(class_hierarchy_heads["level_3_bedroom_objects_head"]) + 1}),
    level_3_bathroom_objects_head=dict(common_auxiliary_head, **{
        "num_classes": len(class_hierarchy_heads["level_3_bathroom_objects_head"]) + 1}),
    level_3_other_indoor_objects_head=dict(common_auxiliary_head, **{
        "num_classes": len(class_hierarchy_heads["level_3_other_indoor_objects_head"]) + 1}),
    level_3_electronics_head=dict(common_auxiliary_head,
                                  **{"num_classes": len(class_hierarchy_heads["level_3_electronics_head"]) + 1}),
    level_3_kitchen_objects_head=dict(common_auxiliary_head, **{
        "num_classes": len(class_hierarchy_heads["level_3_kitchen_objects_head"]) + 1})
)
...
model = dict(
    ...
    auxiliary_head=hierarchical_aux_heads_config,
